...
//    By descriptionInput = By.className("wysihtml5-editor");
    ...
    WebElement ifram = driver.getDriver().findElement(By.xpath("/html/body/div[1]/section/div/div[2]/div/div/form/div/div[5]/div[1]/div/div/div[2]/iframe"));
   ...
   public By errorStatusMsg = By.id("newStatusMsg");
    ...
    public void addFareRuleWithValidData(String chargeName,String supplierName,String airline,String countryFrom,String countryTo) throws InterruptedException {
        ...
        driver.getDriver().switchTo().frame(ifram);
